          ...
          >
            ...
            <div className="glass rounded-xl p-4 flex-1 min-w-0 sm:p-5">
              <div className="mb-1 flex flex-wrap items-center justify-between gap-2">
                <h3 className="text-base font-semibold break-words sm:text-lg">{exp.role}</h3>
                <span className="text-sm text-zinc-500">{exp.duration}</span>
              </div>
              <p className="text-accent-400 break-words">{exp.company}</p>
              <p className="mt-2 text-sm text-zinc-400 break-words sm:text-base">{exp.focus}</p>
            </div>
          </motion.div>
        ))}
      </div>
